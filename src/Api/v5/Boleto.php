...
namespace PagueVeloz\Api\v5;

use PagueVeloz\Api\InterfaceApi;
use PagueVeloz\Api\v5\Dto\BoletoDTO;
...
class Boleto extends ServiceProvider implements InterfaceApi
{
    ...
    public function Get($IncluirCancelados = false, $ApenasAgendados = false, $NaoVisualizados = false)
    {
        $this->method = 'GET';
        $this->Authorization();
        ...
        if ($IncluirCancelados) {
            $filters[] = 'IncluirCancelados=1';
        }
        if ($ApenasAgendados) {
            $filters[] = 'ApenasAgendados=1';
        }
        if ($NaoVisualizados) {
            $filters[] = 'NaoVisualizados=1';
        }
